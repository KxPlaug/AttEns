from saliency.core import pgd_step,pgd_step_gai,pgd_step_gai2,pgd_step_loss_balance,pgd_step_gai3,pgd_step_gai4,pgd_step_kl,pgd_step_kl_new
import random
import torch
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

def agi(model, data, target, epsilon=0.05, max_iter=5, topk=5):
